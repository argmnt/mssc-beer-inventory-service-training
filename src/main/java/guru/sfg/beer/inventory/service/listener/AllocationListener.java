...
public class AllocationListener {
    ...
    public void allocateOrderResultListener(AllocateOrderRequest allocateOrderRequest) {
        ...
        try {
            ...
            log.error("Allocation falied for Order Id: " + allocateOrderRequest.getBeerOrderDto().getId());
